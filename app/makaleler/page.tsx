        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="w-full max-w-sm">
              <form className="relative flex gap-2" method="get" action="/makaleler">
                ...
                {hasQuery && (
                  <Button asChild size="sm" variant="outline">
                    <Link href="/makaleler">Temizle</Link>
                  </Button>
                )}
              </form>
            </div>
          ...
          <div className="flex items-center gap-2 flex-wrap mb-8">
              {categories
                ...
                .map((cat: any) => {
                  ...
                  const href = cat.slug ? `/makaleler?cat=${encodeURIComponent(cat.slug)}` : "/makaleler"
              return (
                <Link
                      key={cat.id}
                  href={href}
