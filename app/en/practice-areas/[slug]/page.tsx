...
// ── EN → TR slug mapping for hreflang ────────────────────────────────────────
const enToTrSlugMap: Record<string, string> = {
...
export async function generateMetadata(
  ...
  // If a direct TR equivalent exists, link to that detail page; otherwise fall back to list
  const trSlug = enToTrSlugMap[slug]
  const trUrl = trSlug
    ? `${base}/tr/calisma-alanlari/${trSlug}`
    : `${base}/tr/calisma-alanlari`
