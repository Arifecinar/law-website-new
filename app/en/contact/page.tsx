...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Taş Law Firm. Contact us for legal consulting and appointment requests.",
  alternates: {
    canonical: `${CANONICAL_BASE}/en/contact`,
    languages: {
      "en": `${CANONICAL_BASE}/en/contact`,
      "tr": `${CANONICAL_BASE}/tr/iletisim`,
      "x-default": `${CANONICAL_BASE}/tr/iletisim`,
    },
  },
  openGraph: {
    type: "website",
    title: "Contact | Taş Law Firm",
    description:
      "Get in touch with Taş Law Firm. Contact us for legal consulting and appointment requests.",
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-gradient-to-b from-background to-secondary/30">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h1 className="text-5xl md:text-6xl font-serif font-light text-balance leading-tight">Contact</h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">Our contact information and form are below.</p>
          </div>
        </div>
      </section>
