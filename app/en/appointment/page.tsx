...
export const metadata: Metadata = {
  title: "Appointment",
  description:
    "Schedule a consultation with Taş Law Firm. Take the first step toward resolving your legal matter.",
  alternates: {
    canonical: `${CANONICAL_BASE}/en/appointment`,
    languages: {
      "en": `${CANONICAL_BASE}/en/appointment`,
      "tr": `${CANONICAL_BASE}/tr/online-randevu`,
      "x-default": `${CANONICAL_BASE}/tr/online-randevu`,
    },
  },
  openGraph: {
    type: "website",
    title: "Schedule Consultation | Taş Law Firm",
    description:
      "Schedule a consultation with Taş Law Firm. Take the first step toward resolving your legal matter.",
