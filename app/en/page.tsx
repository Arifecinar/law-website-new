...
export const metadata: Metadata = {
  title: "Taş Law Firm & Consulting - İzmir",
  description:
    "Expert legal consulting and advocacy in employment, criminal, family, inheritance, commercial and real estate law in İzmir.",
  keywords: [
    "izmir lawyer",
    "law firm izmir",
    "employment lawyer",
    "criminal lawyer izmir",
    "family law",
    "real estate lawyer",
    "inheritance law",
    "commercial law",
  ...
  alternates: {
    canonical: "https://www.taslawfirm.com.tr/en",
    languages: {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative mt-20 min-h-[calc(100vh-80px)] md:h-[calc(100vh-80px)] flex items-center justify-center py-12 md:py-0 pb-16 md:pb-24 lg:pb-36 overflow-hidden">
        ...
        <Image
          ...
          alt="Taş Law Firm & Consulting Hero"
          fill
          priority
          sizes="100vw"
        ...
        <div className="relative z-10 flex items-center justify-center h-full w-full">
          <div className="text-center max-w-4xl mx-auto px-5 md:px-6">
            ...
            <h1 className="text-[1.75rem] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold text-white text-balance leading-[1.15] md:leading-[1.05] tracking-tight animate-fade-in-up delay-100 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
              Effective Solutions to Protect Your Rights
            </h1>
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 text-pretty leading-relaxed max-w-3xl mx-auto animate-fade-in-up delay-200 drop-shadow-md mt-4 md:mt-6 px-2">
              We provide effective and swift solutions to your legal issues.
            </p>
      ...
      <section className="py-12 md:py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <ScrollReveal className="max-w-3xl mx-auto text-center mb-8 md:mb-12 space-y-3 md:space-y-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-light text-balance">Latest Articles</h2>
            <p className="text-base md:text-lg text-muted-foreground">Featured highlights from our legal insights</p>
          </ScrollReveal>
      ...
      <section className="py-16 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 lg:px-8">
          <ScrollReveal className="max-w-3xl mx-auto text-center mb-10 md:mb-16 space-y-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-light text-balance">Our Practice Areas</h2>
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground text-pretty leading-relaxed px-4">
              We offer legal consulting and litigation services across a wide range of areas
            </p>
          </ScrollReveal>
            ...
            <ScrollReveal delay={0}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Employment Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Expert legal support for protecting employee and employer rights, employment contracts, compensation claims, and workplace accidents.
                  </p>
                  <Link
            ...
            <ScrollReveal delay={100}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Criminal Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Professional representation in criminal defense, criminal complaints, petitions, and all legal proceedings within criminal law.
                  </p>
                  <Link
                    href="/en/practice-areas"
                    className="inline-flex items-center text-accent hover:text-accent/80 font-medium group-hover:gap-3 gap-2 transition-all text-sm md:text-base"
            ...
            <ScrollReveal delay={200}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Family Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Experienced legal services for divorce, custody, alimony, property division, and resolution of family legal matters.
                  </p>
                  <Link
                    href="/en/practice-areas"
                    className="inline-flex items-center text-accent hover:text-accent/80 font-medium group-hover:gap-3 gap-2 transition-all text-sm md:text-base"
            ...
            <ScrollReveal delay={300}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Real Estate Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Legal consulting for title deed procedures, lease agreements, eviction cases, and real estate transactions.
                  </p>
                  <Link
                    href="/en/practice-areas"
                    className="inline-flex items-center text-accent hover:text-accent/80 font-medium group-hover:gap-3 gap-2 transition-all text-sm md:text-base"
            ...
            <ScrollReveal delay={400}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Inheritance Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Resolution of inheritance disputes, will preparation, estate determination, and inheritance-related legal matters.
                  </p>
                  <Link
                    href="/en/practice-areas"
                    className="inline-flex items-center text-accent hover:text-accent/80 font-medium group-hover:gap-3 gap-2 transition-all text-sm md:text-base"
            ...
            <ScrollReveal delay={500}>
              <Card className="border-2 border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 group card-hover-lift h-full">
                <CardContent className="p-6 md:p-8 space-y-4 md:space-y-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-semibold">Commercial Law</h3>
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                    Legal support for company formation, commercial contracts, partnership disputes, and commercial debt cases.
                  </p>
                  <Link
                    href="/en/practice-areas"
                    className="inline-flex items-center text-accent hover:text-accent/80 font-medium group-hover:gap-3 gap-2 transition-all text-sm md:text-base"
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-secondary/30">
        <div className="container mx-auto px-4 lg:px-8">
          <ScrollReveal className="max-w-3xl mx-auto text-center mb-10 md:mb-16 space-y-4">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground text-pretty leading-relaxed px-4">
              We make a difference with our client satisfaction and success-oriented approach
            </p>
          </ScrollReveal>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto">
            <ScrollReveal delay={0} className="text-center space-y-4 md:space-y-5">
              ...
              <h3 className="text-xl md:text-2xl font-serif font-semibold">Proven Success</h3>
              <p className="text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">
                With years of experience and hundreds of successful cases, we deliver the best results for our clients.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={150} className="text-center space-y-4 md:space-y-5">
              ...
              <h3 className="text-xl md:text-2xl font-serif font-semibold">Client-Focused</h3>
              <p className="text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">
                We create tailored solutions for each client, stand by you throughout the legal process, and defend your rights to the fullest.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300} className="text-center space-y-4 md:space-y-5 sm:col-span-2 md:col-span-1">
              ...
              <h3 className="text-xl md:text-2xl font-serif font-semibold">Expert Team</h3>
              <p className="text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">
                Our specialized attorneys provide professional consulting and representation services across all legal matters.
              </p>
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          <ScrollReveal className="max-w-3xl mx-auto text-center space-y-6 md:space-y-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-primary-foreground/90 text-pretty leading-relaxed px-4">
              Get in touch with our experienced attorneys now. Let us create tailored solutions for you.
            </p>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {articles.map((article: any) => {
        ...
        const categoryObj = article.category_id
          ...
          : null
        const category = categoryObj?.name || article.category || "General"
        const author = article.author || "Taş Law Firm"
        const dateSrc = article.published_at || article.created_at
        const dateText = dateSrc ? new Date(dateSrc).toLocaleDateString("en-US") : ""
        return (
          <Card
            key={article.id}
